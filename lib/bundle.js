...
/***/ function(module, exports, __webpack_require__) {
	...
	var TempWorld = __webpack_require__(14);
	var HallwayOne = __webpack_require__(15);
	var EnemyRoom = __webpack_require__(17);
	...
	Game.prototype.blackBars = function () {
	  ...
	  context.fillRect(camera.width, 0, canvas.width - camera.width, window.innerHeight);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	Camera.prototype.move = function (targetObj) {
	  ...
	  this.acel.y += (1 / 3) * (this.target.y - this.cpos.y);
...
/***/ function(module, exports) {
	...
	// StaticObject.prototype.draw = function (camera) {
