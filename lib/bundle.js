	...
	var SpriteUtil = {
	  player: {
	    ...
	    standUpSprite: function () {
	      ...
	      sprite.image.src = 'lib/sprites/player/playergettingupleft1.png';
	  ...
	  updateFrame: function (that) {
	    if(!that.interval) {
	      that.interval = window.setInterval(function () {
	        ...
	        if (that.sprite.frameIdx >= that.sprite.numFrames) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CutsceneUtil = __webpack_require__(27);
...
/***/ function(module, exports, __webpack_require__) {
	...
	RoomFour.prototype.initiate = function () {
	  ...
	  this._staticObjects.push(new this.Trigger({
	    ...
	    activate: function () {
	      if (this.notActivated) {
	        worldContext.CutsceneUtil.levelOneRoomFourScene(function (height) {
