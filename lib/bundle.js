...
/***/ function(module, exports, __webpack_require__) {
	...
	var TempWorld = __webpack_require__(6);
	var canvas = document.getElementById("canvas");
	...
	//         }
	//     }
	//     console.log("collision!" + obj1 + "with" + obj2);
	//     return colDir;
	// };
...
/***/ function(module, exports, __webpack_require__) {
	...
	Camera.prototype.move = function (targetObj) {
	  ...
	  this.target.x = targetObj.cpos.x - (this.width / 2); //sets target x to center of screen relative to player
	  this.target.y = targetObj.cpos.y - (this.height / 2); // same but with y
